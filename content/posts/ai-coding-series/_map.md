...
- GFM 각주 추가(사용자 요청, *억지 배제* 원칙): **4편** Naur(1985, 코드=이론의 그림자) / **5편** Boehm 나선형(1988)·유스케이스 3표준서(Jacobson 1992·Bittner&Spence 2002·Cockburn 2001) / **에필로그(7편)** Agile Manifesto(2001, '변질된 애자일' 논의 근거).
- **제거**: 3편 Parnas(정보은닉) — 글의 모듈화는 *AI 컨텍스트 관리용 작업 분할*이지 Parnas의 분해 기준 논증이 아님. 서지·URL 웹검색 검증.
